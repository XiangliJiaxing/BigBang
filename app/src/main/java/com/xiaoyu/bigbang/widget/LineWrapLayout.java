package com.xiaoyu.bigbang.widget;
...
public class LineWrapLayout extends ViewGroup implements View.OnClickListener {
    ...
    //textview背景ID 点击后背景ID
    private int bgId = 0;
    private int bgPId = 0;
    //TextView 字体颜色
    private int colorNormal = Color.BLACK;
    private int colorPress = Color.WHITE;
    ...
    public LineWrapLayout(Context context, AttributeSet attrs) {
        ...
        bgPId = a.getResourceId(R.styleable.linewarplayout_itemBgPress, R.drawable.text_bg_press);
    }
    ...
    public void setData(List<String> data) {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            textView.setOnClickListener(LineWrapLayout.this);
    ...
    public String getData(){
        ...
        for(View child:selectView){
            builder.append(((TextView)child).getText().toString());
        }
    ...
    public void onClick(View v) {
        ...
        view.setBackgroundResource(bgPId);
        view.setTextColor(colorPress);
        selectView.add(v);
    }
}